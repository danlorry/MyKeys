...
ActiveRecord::Schema.define(version: 20160726184035) do
  ...
  create_table "reviewagents", force: :cascade do |t|
    t.text     "comment"
    t.integer  "star"
    t.integer  "agent_id"
    t.integer  "user_id"
  ...
  add_index "reviewagents", ["agent_id"], name: "index_reviewagents_on_agent_id"
  add_index "reviewagents", ["user_id"], name: "index_reviewagents_on_user_id"
